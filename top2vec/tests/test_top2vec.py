...
# train top2vec model with KMeans
top2vec_kmeans = Top2Vec(documents=newsgroups_documents, kmeans_args = {"n_clusters": 15, "init": "k-means++"}, use_corpus_file=True, speed="fast-learn", workers=8)
...
models = [top2vec, top2vec_docids, top2vec_no_docs, top2vec_corpus_file, top2vec_kmeans,
